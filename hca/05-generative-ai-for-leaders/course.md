...
![Chatbot to agent progression](images/chatbot-to-agent.png)
...
![GenAI landscape layers](images/genai-landscape-layers.png)
...
![Value feasibility risk](images/genai-prioritization.png)
...
![Responsible adoption loop](images/responsible-adoption-loop.png)
...
**Correct: B.** Confident output that is wrong or made up
